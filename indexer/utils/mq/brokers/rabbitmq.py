...
class EnvVars:
    ...
    # RabbitMQ user.
    USER = env.get_var('BROKER_RABBIT_USER', "cdf2cim-indexer-user")

    # RabbitMQ user password.
    USER_PWD = env.get_var('BROKER_RABBIT_USER_PWD', "es-doc")

    # RabbitMQ host.
    VHOST = env.get_var('BROKER_RABBIT_VHOST', "ES-DOC")
